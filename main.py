...
def train_discriminator():
	...
	for batch in DataLoader(train_dataset, batch_size = batch_size, shuffle = True):
		...
		outputs = generator.generate(inputs[ 'input_ids' ], attention_mask = inputs[ 'attention_mask' ], max_length = 150, min_length = 40, length_penalty = 2.0, num_beams = 4, early_stopping = True)
